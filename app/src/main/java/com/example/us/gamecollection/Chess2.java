...
import com.example.us.gamecollection.Pieces.Bishop;
import com.example.us.gamecollection.Pieces.King;
import com.example.us.gamecollection.Pieces.Knight;
import com.example.us.gamecollection.Pieces.Pawn;
import com.example.us.gamecollection.Pieces.Queen;
import com.example.us.gamecollection.Pieces.Rook;
import com.example.us.gamecollection.bidak.Piece;

import java.util.ArrayList;

public class Chess2 extends AppCompatActivity implements View.OnClickListener{
        ...
        for(int i=0;i<8;i++){
            for(int j=0;j<8;j++){
                if(Board[i][j].getPiece() != null){
                    ...
                    List = Board[i][j].getPiece().AllowedMove(c,Board);
        ...
        if (!AnythingSelected) {
            if(Board[clickedPosition.getX()][clickedPosition.getY()].getPiece() == null) {
                ...
                if(Board[clickedPosition.getX()][clickedPosition.getY()].getPiece().isWhite() != FirstPlayerTurn){
                    ...
                    listOfCoordinates = Board[clickedPosition.getX()][clickedPosition.getY()].getPiece().AllowedMove(clickedPosition, Board);
                    ...
                    if(Board[clickedPosition.getX()][clickedPosition.getY()].getPiece() !=null){
                        if(Board[clickedPosition.getX()][clickedPosition.getY()].getPiece().isWhite() != FirstPlayerTurn){
                            if(moveIsAllowed(listOfCoordinates , clickedPosition)){
                                ...
                                resetColorAtAllowedPosition(listOfCoordinates);
                                Toast.makeText(this, "Gerak Makan", Toast.LENGTH_SHORT).show();
                                DisplayBoard[lastPos.getX()][lastPos.getY()].setBackgroundResource(0);
                                resetColorAtLastPosition(lastPos);
